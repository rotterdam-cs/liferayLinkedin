...
package com.aimprosoft.portlet.login.social.util;

/**
 * @author V. Koshelenko
 */
public interface PropsKeysExt {

    public static final String LINKEDIN_CONNECT_APP_ID = "linkedin.connect.app.id";

    public static final String LINKEDIN_CONNECT_APP_SECRET = "linkedin.connect.app.secret";

    public static final String LINKEDIN_REDIRECT_URL = "linkedin.redirect.url";
